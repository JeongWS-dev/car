...
<%
    ...
    //    /MyMVC
%>
<link rel="stylesheet" href="<%= ctxPath%>/css/carDetail/g90Black.css">
...
<div id="container">
	...
	<div id="background-image-1">
		<div id="text-1">
			...
			<span><br>가장 순수한 블랙은 가장 어둡지만, 그렇기에 제네시스의 본질을<br>
				  돋보이게 합니다. 근본부터 새로운 완벽한 블랙을 구현하기 위해 서로<br>
				  다른 질감과 광택의 조화, 반사되고 흡수되는 빛의 양까지 제네시스만의<br>
				  방식으로 섬세하게 그리고 끊임없이 탐구했습니다. 제네시스의 디자인<br>
				  철학인 '역동적인 우아함'으로 재해석한 진정한 블랙의 경험을 제네시스<br>
				  G90 Black으로 선사합니다.
			</span>
		</div>
   	</div>
   	<div id="background-image-2">
   		<div id="text-2">
	   		<span style="font-weight: bold; color:#737373;">영감</span>
			<h1>근본부터 완전히 새로운 블랙</h1>
			<span>어둠에서 모든 것이 창조되듯이, 블랙은 가장 순수한 근원의 색입니다. 어둠 안에서<br>
				  모든 감각은 더 선명하게 살아나고, 이를 통해 본질의 세계로 다가갈 수 있습니다.<br>
			 	  블랙은 창조와 영감에 대한 무한한 가능성을 의미합니다. 제네시스만의 방식으로<br>
			  	  해석한 차별화된 블랙을 구현하기 위해 안과 밖, 그리고 아주 섬세한 부분까지 서로<br>
			   	  다른 블랙을 조화롭게 적용했습니다. 본질의 세계에 다가가는 잊을 수 없는 경험을<br>
			      제공합니다.
			</span>
		</div>
   	</div>
	...
	<div id="spec" style="background-color: white;">
		...
		<span style="font-weight: 300; color: black; font-size: 50px;">G90 BLACK의 스펙을 확인해보세요.<br><br></span>
		<div id="carsize">
			<img src="<%=ctxPath%>/images/carDetail/g90Black/single-1.png"/>
			<img src="<%=ctxPath%>/images/carDetail/g90Black/single-3.png"/>
			<img src="<%=ctxPath%>/images/carDetail/g90Black/single-2.png"/>
		</div>
