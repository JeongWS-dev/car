...
<%
    ...
    //    /MyMVC
%>
<link rel="stylesheet" href="<%= ctxPath%>/css/carDetail/g70_SHOOTING_BRAKE.css">
<jsp:include page="../Main_Header.jsp"></jsp:include>
<div id="container">

	<div id="background-image-1">
		<div id="text-1">
            <div id="carname" style="font-size: 50pt; font-weight: 300;">G70_SHOOTING_BRAKE<br><br></div>
	...
	<div id="spec" style="background-color: white;">
		...
		<span style="font-weight: 300; color: black; font-size: 40px;">GV70의 스펙을 확인해보세요.<br><br></span>
		<div id="carsize">
