...
<%
    ...
    //    /MyMVC
%>
<link rel="stylesheet" href="<%= ctxPath%>/css/carDetail/g70.css">
<jsp:include page="../Main_Header.jsp"></jsp:include>
<div id="container">
    <video id="video" autoplay muted loop>
        <source src="<%= ctxPath %>/video/detail_video/g70.mp4" type="video/mp4">
    </video>
    <div id="title">
		<div id="carname" style="font-size: 50pt; font-weight: 300;">G70<br><br></div>
	...
	<div id="spec" style="background-color: white;">
		...
		<span style="font-weight: 300; color: black; font-size: 40px;">G70의 스펙을 확인해보세요.<br><br></span>
		<div id="carsize">
