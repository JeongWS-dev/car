                    ...
                    if(cartype1 == "SEDAN"){
                        ...
                        $.each(json, function(index, item){
                            if((index+1)%3 == 1 || index == 0){
                                console.log(index);
                                v_html +=`<div style="display: flex; width: 200%;">`;
                            };
                            v_html +=`<div>
                                        <div id="cartype" class="card" style="height: 100%; margin-left: 0%; margin-top: 1.5%; width: 21rem; background-color:#141414; border: solid 0px white;" >`;
                            
                            if(item.carpoint == 'ELECTRIFIED'){
                                v_html += `<h5 class="card-title" style="margin-bottom: 9%; font-size: 16px; font-weight: 400; color: #bfbfbf; text-align: left;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${item.carpoint}</h5>`;
                            };
                            ...
                            if(item.carpoint == 'LONG_WHEEL_BASE' || item.carpoint == 'SHOOTING_BRAKE'){
                                v_html += `<h5 class="card-title" style="margin-bottom: 7%; margin-top: -10%; font-size: 16px; font-weight: 400; color: #bfbfbf; text-align: left;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${item.carpoint}</h5>`
                            };            
