...
<body>
   ...
   <div class="container">
    ...
    <div class="faq-form">
	    ...
	    <input type="text" name="searchWord" id="faq-search" placeholder="검색어를 입력해주세요." style="border-top: none; border-right: none; border-left: none; margin-top: 1%;"/>
	    <button type="submit" class="ico-search"  title="검색">
