...
public class GoogleMail {
    ...
    */ 
        ...
        body += "<h1 style='color: red;'>" + certification_code + "</h1>";
        body += "<h3>" + "감사합니다." + "</h3>";
	...
	public void send_paper(String email, String emailContents)  throws Exception{
		// 1. 정보를 담기 위한 객체
    	Properties prop = new Properties(); 
    ...
    */ 
	...
	public void send_reservation(String place_email, String emailContents)  throws Exception{
		// 1. 정보를 담기 위한 객체
    	Properties prop = new Properties(); 
    ...
    */ 
    	...
    	// 받는 사람의 메일주소
    	Address toAddr = new InternetAddress(place_email);
    	msg.addRecipient(Message.RecipientType.TO, toAddr);
